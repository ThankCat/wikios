...
func NewRouter(cfg *config.Config, handlers *api.Handlers, dataStore *store.Store) *gin.Engine {
	...
	admin.POST("/public-answer/audit", handlers.AdminPublicAnswerAudit)
	admin.POST("/public-answer/audit/stream", handlers.AdminPublicAnswerAuditStream)
	...
	admin.GET("/public-conversations", handlers.AdminPublicConversations)
	admin.GET("/public-conversations/:session_id", handlers.AdminPublicConversationDetail)
